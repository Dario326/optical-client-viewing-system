...
angular.module('app').controller('AppCtrl', ['$scope',
    function($scope) {
        ...
        $scope.app = {
            name: 'Optical | client Viewing System',
            version: '4.0.0',
            type: 'freelancing', // general,hospital,university,music,crm,blog,socialmedia,freelancing,ecommerce
            color: {
                primary: '#673AB7',
                accent: '#FF6E40',
                info: '#26C6DA',
            ...
            settings: {
                ...
                layoutBoxed: false,
                searchFocus: false,
                pagetitle: 'Optical \\ Client Viewing System',
            }
        }
